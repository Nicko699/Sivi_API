...
public class ProductoListarAdminResponseDto {
    private Long id;
    ...
    public ProductoListarAdminResponseDto() {
    }

    public ProductoListarAdminResponseDto(Long id, String codigoBarras, String nombre, String descripcion, BigDecimal precioVenta, BigDecimal stockTotal, BigDecimal stockMinimoAlerta, Boolean bajoStock, Boolean activo, ProductoTipoVenta tipoVenta, ProductoUnidadBase unidadBase, LocalDateTime fechaCreacion, LocalDateTime fechaActualizacion, ProductoCategoriaResponseDto categoria, ProductoMarcaResponseDto marca) {
        this.id = id;
